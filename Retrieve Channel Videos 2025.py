...
# ========== MAIN SCRIPT (UPDATED DATE RANGE) ==========
all_metadata = []
all_channel_ids = set()
...
for channel_id in channel_ids:
    ...
    video_ids = []
    # Only fetch medium and long videos (skip shorts) from 2016-2021
    for duration in ["medium", "long"]:
        ...
        while len(video_ids) < max_videos_per_channel:
            search_params = {
                ...
                "publishedAfter": "2016-01-01T00:00:00Z",  # Start of 2016
                "publishedBefore": "2022-01-01T00:00:00Z", # Start of 2022 (exclusive)
    ...
    print(f"  Found {len(video_ids)} medium/long videos (2016-2021).")
...
output_filename = f"metadata_rows_{selection_str}_2016-2021.csv"  # Updated filename
