<<<<<<< HEAD:Thesis Code/Thesis - Python Scripts/04 - Preprocessing & Feature Engineering.py
import os
import pandas as pd
import numpy as np
import ast
...
if len(existing_columns) < len(COLUMNS_TO_KEEP):
    missing = set(COLUMNS_TO_KEEP) - set(existing_columns)
    print(f"Warning: Missing columns: {missing}")
>>>>>>> 389eb687f3f3be30b59cb83315bd2adffab0f838:Thesis Code/Thesis - Python Scripts/Preprocessing & Feature Engineering.py
